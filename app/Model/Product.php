...
class Product
{
    ...
    public function __construct($prduktove_cislo,$katalogove_cislo,$predkontace,$popis,$dodatecne_info,$hmotnost,$ryzost,$novinka,$akce,$cena,$zaruka,$zaruka_mesice,$pocet_sklad)
    {
